...
def get_ali_rds_ip():
    ali = alis('LTAIP4zK7XrpF6FB', 'Qbfwkp8sNRtHC8vWc4gDfRYxRn9OvT', 'cn-hangzhou')  # 需改为华东1（cn-hangzhou)
    clt = ali.clt()
    ask = ali.describeDBInstanceIPArrayListRequest('rm-bp1m138ik7m9t03dq')  #查看白名单
